...
If you want to jump straight into the full-fletched topological optimization, check out **[`notebooks/example3_e2e_pipeline.ipynb`](../notebooks/example3_e2e_pipeline.ipynb)**.
You can run any grid file (compatible with PyPowsybl) of your choice and investigate the effects.

If you want to take smaller steps, start with **[`notebooks/example1_dc_loadflow_example.ipynb`](../notebooks/example1_dc_loadflow_example.ipynb)**.
After that, take a look at **[`notebooks/example2_small_grid_toop.ipynb`](../notebooks/example2_small_grid_toop.ipynb)**.

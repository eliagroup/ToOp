...
If you want to jump straight into the full-fletched topological optimization, check out **[`notebooks/example3_e2e_pipeline.ipynb`](https://github.com/eliagroup/ToOp/blob/main/notebooks/example3_e2e_pipeline.ipynb)**.

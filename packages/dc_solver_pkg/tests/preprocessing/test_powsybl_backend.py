...
def test_loadflows_match_bat_hvdc_shunt_svc(complex_grid_battery_hvdc_svc_3w_trafo_fixture: Path) -> None:
    preprocessed_powsybl_data_folder = complex_grid_battery_hvdc_svc_3w_trafo_fixture
    net = pypowsybl.network.load(preprocessed_powsybl_data_folder / PREPROCESSING_PATHS["grid_file_path_powsybl"])

...
def test_add_missing_branch_model_columns() -> None:
    ...
    assert normalized_branches.loc["branch_id", "has_pst_tap"] is False
    assert normalized_branches.loc["branch_id", "has_pst_linear_tap"] is False
    assert normalized_branches.loc["branch_id", "for_reward"] is False
    assert normalized_branches.loc["branch_id", "for_nminus1"] is False

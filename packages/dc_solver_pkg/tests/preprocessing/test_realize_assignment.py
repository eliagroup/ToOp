...
def _asset_connections(*asset_ids: str) -> list[RuntimeAssetConnection]:
    return [RuntimeAssetConnection(asset=RuntimeBranchAsset(grid_model_id=asset_id)) for asset_id in asset_ids]

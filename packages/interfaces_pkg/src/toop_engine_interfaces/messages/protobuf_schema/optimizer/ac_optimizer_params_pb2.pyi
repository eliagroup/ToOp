...
class ACGAParameters(google.protobuf.message.Message):
    ...
    """Whether to enable AC rejection — i.e., suppress result messages when not accepted."""

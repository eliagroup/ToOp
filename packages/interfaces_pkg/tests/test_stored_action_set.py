...
def build_simplified_bus_group(
    ...
    """Build a simplified bus group using split branch/injection fields."""
...
def test_validate_actions_grouped_accepts_grouped_actions():
    station_s1 = SimplifiedBusGroup.model_construct(
        bus_group_id="s1",
        name=None,
        voltage_level_id=None,
        station_type=None,
...
def test_action_set_model_validator_rejects_non_grouped_local_actions():
    ...
    station_a = SimplifiedBusGroup.model_construct(
...
def test_compress_and_expand_station_diffs_random_roundtrip():
    ...
    expected_by_station: dict[str, list[SimplifiedBusGroup]] = {}
    ...
    for station_idx in range(n_stations):
        ...
        starting_station = build_simplified_bus_group(
        ...
        station_actions: list[SimplifiedBusGroup] = []
...
def test_compress_station_diffs_raises_on_non_diff_hypothesis_change():
    ...
    invalid_action = SimplifiedBusGroup.model_construct(**invalid_action_payload)

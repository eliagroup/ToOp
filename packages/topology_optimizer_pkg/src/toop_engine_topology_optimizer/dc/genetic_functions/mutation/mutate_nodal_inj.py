...
def mutate_psts(
    ...
    pst_starting_taps: Int[Array, " n_controllable_linear_pst"]
        The initial PST taps of each controllable linear PST.
    pst_mutation_sigma : float | int
    ...
    """
    # Sample number of PSTs to adjust from a n_controllable_linear_pst-dimensional uniform distribution
